...
public class SharedArrayTest {
	public static void main(String[] args) {
		...
		SimpleArray sharedSimpleArray = new SimpleArray(Integer.parseInt(args[0]));

		// create tasks to write to the shared SimpleArray
		ArrayWriter writer1 = new ArrayWriter(1, sharedSimpleArray);
		ArrayWriter writer2 = new ArrayWriter(5, sharedSimpleArray);
		ArrayWriter writer3 = new ArrayWriter(9, sharedSimpleArray);
